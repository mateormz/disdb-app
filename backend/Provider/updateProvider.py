    ...
    try:
        ...
        if provider['PK'] != authenticated_pk:
            ...
            return {
                'statusCode': 403,
                'headers': {'Content-Type': 'application/json'},
                'body': json.dumps({'error': 'Unauthorized - You can only update your own providers'})
            }
        ...
        print("[INFO] Updating provider in DynamoDB")
        ...
        print("[INFO] Provider updated successfully")
        return {
            'statusCode': 200,
            'headers': {'Content-Type': 'application/json'},
            'body': json.dumps({'message': 'Provider updated successfully'})
        }
